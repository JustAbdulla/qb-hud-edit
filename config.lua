...
Config.MinimumStress = 10 -- Minimum Stress Level For Screen Shaking
Config.MinimumSpeedUnbuckled = 220 -- Going Over This Speed Unbuckled Will Cause Stress
Config.MinimumSpeed = 220 -- Going Over This Speed While Buckled Will Cause Stress
