  ...
  methods: {
    hudTick(data) {
      ...
      if (data.radio != 0 && data.radio != undefined) {
        this.voiceIcon = 'fas fa-podcast';
      } else if (data.radio == 0 || data.radio == undefined) {
        this.voiceIcon = 'fas fa-microphone-alt';
      }
      if (data.cruise === true) {
        this.cruise = 1;
